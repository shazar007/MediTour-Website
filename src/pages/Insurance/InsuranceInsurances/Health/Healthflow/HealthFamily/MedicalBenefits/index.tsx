...
import { insuranceHealthFamilyMedicalBenefits } from "shared/utils";
...
function MYselfBenefitsPolices(props: Partial<Props>) {
  ...
  const handleSelectCoverage = (selectedOption: string) => {
    formik.setFieldValue("opd", selectedOption);
  };
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object(insuranceHealthFamilyMedicalBenefits),
    onSubmit: (values) => {
      handleSubmit();
    },
  });
  ...
  return (
    <div className={commonstyle.col12}>
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className={classNames(commonStyles.flxEnd, commonStyles.mt24)}>
