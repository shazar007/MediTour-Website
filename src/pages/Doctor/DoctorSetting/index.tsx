...
import { setDoctor } from "shared/redux";
import { DoctorUpdateProfile } from "shared/services/DoctorService";
export default function DoctorSetting() {
  ...
  return (
    ...
    >
      <SearchBar />
      <div className={classNames(style.mr87)}>
                    ...
                    <div className={commonstyle.colorBlue}>
                      <div className={commonstyle.flx}>
                        <div className={commonstyle.col6}>
                          <div className={style.flx}>
                            <p className={commonstyle.col4}>Doctor Name</p>
                          ...
                          <div className={classNames(style.flx)}>
                            ...
                            <div className={commonstyle.col4}>
                              ...
                              />
                              {formik.touched.name && formik.errors.state ? (
                                <div className={classNames(commonStyles.error)}>
                                  *{`${formik.errors.state}`}
                                </div>
                              ) : null}
