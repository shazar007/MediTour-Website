      ...
      <div className={style.cardbody}>
        <div className={style.firstcol}>
          <div className={style.imgcontainer}>
            <img src={cardImage} alt="CardImages" className={style.img} />
          </div>
...
const ListItem = ({ img, item }: any) => {
  return (
    ...
    >
      ...
      >
        <img src={img} alt="card2" style={{ width: "100%", height: "100%" }} />
      </div>
...
const Address = ({ img, item }: any) => {
  return (
    ...
    >
      ...
      >
        <img src={img} alt="sssaa" style={{ width: "100%", height: "100%" }} />
      </div>
