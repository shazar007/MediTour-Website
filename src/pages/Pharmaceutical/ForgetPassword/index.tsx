...
const Phramceutical_ForgetPassword = () => {
  const [SuccessModel, setSuccessModel] = useState(false);
  const [error, setError] = React.useState("");
  const navigate = useNavigate();
  const handleGoToHome = () => {
    navigate("/pharmaceutical/login");
  };
      ...
      <div className={classNames(commonStyles.container)}>
        ...
        <form onSubmit={formik.handleSubmit}>
          <div className={classNames(phrMainStyles.flxBetween)}>
            ...
            >
              <img src={Logo} alt="Logos" className={commonStyles.lockVector} />
            </div>
          </div>
        </form>
        <CustomModal
...
export default Phramceutical_ForgetPassword;
