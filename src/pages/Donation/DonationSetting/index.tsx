...
import { donationUpdateProfile } from "shared/services/Donation";
import { setDonation } from "shared/redux";
export default function DonationSetting() {
  ...
  const UpdateProfile = (params: any) => {
    donationUpdateProfile(params)
      .then((res: any) => {
        dispatch(setDonation(res?.data?.donation));
      })
      .catch((err: any) => {})
      .finally(() => {});
  };
  ...
  return (
    ...
    >
      ...
      <div className={classNames(commonstyle.mr87)}>
        <div className={commonstyle.outerContainer2}>
