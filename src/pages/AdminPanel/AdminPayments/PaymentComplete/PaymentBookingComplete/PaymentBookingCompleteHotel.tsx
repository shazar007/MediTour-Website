...
const PaymentBookingCompleteHotel = (props: Partial<Props>) => {
  const { Data } = props;
  const navigate = useNavigate();

  const handleGoToDetailTABLE = (val: any, index: any) => {
    navigate("/admin/Payments/PaymentComplete/Detail", {
      state: { heading: "Payment Booking Hotel", type: "Booking", Data: val },
    });
  };
  return (
...
export default PaymentBookingCompleteHotel;
