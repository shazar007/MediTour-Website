...
import Styles from "./LaboratoryPayments.module.css";
...
const LaboratoryPayments = (props: Partial<Props>) => {
  ...
  const handleGoToDetail = (index: any) => {
    ...
    navigate("/admin/Payments/PaymentOrder/laboratoryDetails", {
      state: result[0],
    });
  };
...
export default LaboratoryPayments;
