...
const VideoConsultancy = (props: Partial<VideoConsultancy>) => {
    ...
    DoctorGetAvailibility()
      .then((res: any) => {
        if (res?.status === 200) {
          ...
          setPrice(res.data?.availability[0]?.videoAvailability?.price);
          const apiPhysicalAvailability =
            res.data?.availability[0]?.videoAvailability?.availability || [];
            ...
            <div className={commomstyles.mr87}>
              <div className={style.outerContainer}>
                <div className={commomstyles.flx}>
                  ...
                  >
                    Availablitiy Video Consultancy
                  </p>
